...
--
-- Servidor: 127.0.0.1
-- Tiempo de generacion: 24-06-2026
...
ALTER TABLE `perfil`
  ...
  ADD KEY `fk_profile_specialty` (`specialty_id`);
...
ALTER TABLE `perfil`
  ...
  ADD CONSTRAINT `fk_profile_specialty` FOREIGN KEY (`specialty_id`) REFERENCES `specialties` (`id`);
